% TODO: bibliographic references are parenthetic, so they should not be used as part of the sentence. They should just appear in their square brackets at the end. Fix where this is not respected
