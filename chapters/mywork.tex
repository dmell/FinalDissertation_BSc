...
Concretely, assets are represented in the system as collections of key-value pair, usually in JSON dictionaries. Every update of the assets is saved in the ledger.
...
\begin{description}
    ...
    \item General peers: ordinary peers, that can submit transactions from their client applications.
\end{description}
...
\begin{enumerate}
    \item A general node invokes a transaction request. This can be done though a client application.
